...
auth_sheet1 = pe.get_sheet (file_name= "RSU_Auth1_ICC.xlsx")

# Create a TCP/IP socket
SDNC_socket = socket.socket(socket.AF_INET, socket.SOCK_STREAM)

# Connect the socket to the server's address and port
server_address = ('10.13.4.78', 9911)
    ...
    while True : 
        ...
        if get_timestamp () - T1 < 4 :
            ...
            if Auth_status == "S" :
                ...
                auth_sheet1.row += [ RSU_ID, comp_time ]
                auth_sheet1.save_as ("RSU_Auth1_ICC.xlsx")
